...
define(["modernizr",
    ...
    "bootstrap-select",
    "bootstrap-table",
    "js/app/components/header/header.js",
    "js/app/components/headerFooter/headerFooter.js"

], function (modernizr, $, bootstrap, Handlebars, moment, calendar, bootstrapSelect, bootstrapTable, _header, _headerFooter) {

    
    //Compiling HBS templates
    var compiledDefaultDdn = Handlebars.compile($("#defaultDdn-template").html());
    var compiledsearchDate = Handlebars.compile($("#calendar-template").html());
    var compiledsearchForm = Handlebars.compile($("#searchForm-template").html());
    var compiledinvoicesSummary = Handlebars.compile($("#invoicesSummary-template").html());
    var compiledBottomDetail = Handlebars.compile($("#bottomDetail-template").html());
