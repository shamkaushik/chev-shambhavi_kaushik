...
define(["jquery",
        "handlebars", 
        "text!/www/js/app/components/header/_header.hbs",
        "text!/www/js/app/components/footer/_footer.hbs"
        ], function($, Handlebars, _headerHBS, _footerHBS) {
*/ 
define(["jquery",
        "handlebars",
        "jqueryHoverIntent"
        ], function($, Handlebars, hoverIntent) {
   

    var _headerHBS = $("#header-template").html(),
        _footerHBS = $("#footer-template").html();
