...
require(["modernizr",
    ...
    var eftSearchPage = (function () {
        ...
        var init = function () {
            ...
            if (localStorage.getItem("eftObj") === undefined || localStorage.getItem("eftObj") === null) {
                populatingTable(cbp.eftSearchPage.eftSearchResponse.eftSearchDetailDataList);
            } else {
        ...
        var triggerAjaxRequest = function () {
            ...
            function successCallback(data) {
                ...
                if (cbp.eftSearchPage.eftSearchResponse.eftSearchDetailDataList === undefined || cbp.eftSearchPage.eftSearchResponse.eftSearchDetailDataList === null) {
                    cbp.eftSearchPage.eftSearchResponse.eftSearchDetailDataList = [];
                }
        ...
        var populatingTable = function (eftSearchDetailDataList) {
            var eftStatusCount = 0;
            if (cbp.eftSearchPage.eftSearchResponse.multipleSoldTo && cbp.eftSearchPage.eftSearchResponse.eftSearchDetailDataList === null) {
            ...
            if (eftSearchDetailDataList === null || eftSearchDetailDataList === undefined) {
                eftSearchDetailDataList = [];
            }
            ...
            $('#table').bootstrapTable({
                ...
                columns: [{
                    ...
                    title: cbp.eftSearchPage.globalVars.documentNumber,
                    titleTooltip: cbp.eftSearchPage.globalVars.documentNumber,
                    class: 'text-nowrap',
                    ...
                    field: 'referenceDate',
                    title: cbp.eftSearchPage.globalVars.referenceDate,
                    titleTooltip: cbp.eftSearchPage.globalVars.referenceDate,
                    class: 'numberIcon text-nowrap',
                    sortable: true
                }, {
                    field: 'originalDoc',
                    title: cbp.eftSearchPage.globalVars.originalDoc,
                    titleTooltip: cbp.eftSearchPage.globalVars.originalDoc,
                    class: 'numberIcon',
                    sortable: true
                }, {
                    field: 'referenceNumber',
                    title: cbp.eftSearchPage.globalVars.referenceNumber,
                    titleTooltip: cbp.eftSearchPage.globalVars.referenceNumber,
                    class: 'numberIcon text-nowrap',
                    ...
                    title: cbp.eftSearchPage.globalVars.descriptionText,
                    titleTooltip: cbp.eftSearchPage.globalVars.descriptionText,
                    class: 'numberIcon text-nowrap col-md-5',
                    sortable: true
                },{
                    field: 'deliveryAccount',
                    title: cbp.eftSearchPage.globalVars.deliveryAccount,
                    titleTooltip: cbp.eftSearchPage.globalVars.deliveryAccount,
                    class: 'numberIcon text-nowrap',
                    sortable: true
                }, {
                    field: 'totalTbSD',
                    title: cbp.eftSearchPage.globalVars.totalTbSD + " (" + cbp.eftSearchPage.eftSearchResponse.currency + ")",
                    titleTooltip: cbp.eftSearchPage.globalVars.totalTbSD + " (" + cbp.eftSearchPage.eftSearchResponse.currency + ")",
                    class: 'numberIcon text-nowrap',
                    sortable: true,
                    align: 'right',
                    ...
                    formatter: function LinkFormatter(value, row, index) {
                        ...
                        if (value >= '0') {
                            ...
                            total = "<span class='text-danger'>" + row.totalTbSD + "</span>";
                        }
                        return total;
                    }
                }],
                data: eftSearchDetailDataList
            });
    ...
    $(document).ready(function () {
        ...
        if (eftSearchResponse.eftSearchDetailDataList === undefined || eftSearchResponse.eftSearchDetailDataList === null) {
            cbp.eftSearchPage.eftSearchResponse.eftSearchDetailDataList = [];
        }
